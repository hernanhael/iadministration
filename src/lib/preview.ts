...
export const DEMO_SERVICIOS: ServicioConPlanilla[] = [
  { id: 'srv-luz', user_id: 'demo', planilla_id: 'pl-inm', nombre: 'Luz', empresa: 'EDET', nro_cliente: '3712458-001', url_pago: 'https://www.edet.com.ar', email_remitente: null, dia_vencimiento: 10, color: '#E8B84B', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-inm') },
  { id: 'srv-gas', user_id: 'demo', planilla_id: 'pl-inm', nombre: 'Gas', empresa: 'Gasnor', nro_cliente: 'NIS 70234561', url_pago: 'https://www.gasnor.com', email_remitente: null, dia_vencimiento: 18, color: '#E07A5F', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-inm') },
  { id: 'srv-agua', user_id: 'demo', planilla_id: 'pl-inm', nombre: 'Agua', empresa: 'SAT', nro_cliente: 'Cta 045-7789', url_pago: null, email_remitente: null, dia_vencimiento: 12, color: '#4A9DB8', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-inm') },
  { id: 'srv-exp', user_id: 'demo', planilla_id: 'pl-inm', nombre: 'Expensas', empresa: 'Cons. Av. Aconquija', nro_cliente: 'UF 4-B', url_pago: null, email_remitente: null, dia_vencimiento: 10, color: '#6A8D73', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-inm') },
  { id: 'srv-imp', user_id: 'demo', planilla_id: 'pl-inm', nombre: 'Imp. munic.', empresa: 'Municipalidad SMT', nro_cliente: 'Padrón 88231', url_pago: null, email_remitente: null, dia_vencimiento: 22, color: '#9B6A9E', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-inm') },
  { id: 'srv-gim', user_id: 'demo', planilla_id: 'pl-per', nombre: 'Gimnasio', empresa: 'SportClub', nro_cliente: 'Socio 12233', url_pago: 'https://sportclub.com.ar', email_remitente: null, dia_vencimiento: 1, color: '#D96459', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-per') },
  { id: 'srv-net', user_id: 'demo', planilla_id: 'pl-per', nombre: 'Netflix', empresa: 'Netflix', nro_cliente: 'hernan@…', url_pago: 'https://www.netflix.com/account', email_remitente: null, dia_vencimiento: 20, color: '#5B7DB1', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-per') },
  { id: 'srv-obs', user_id: 'demo', planilla_id: 'pl-per', nombre: 'Obra social', empresa: 'OSDE', nro_cliente: '6-12345678', url_pago: 'https://www.osde.com.ar', email_remitente: null, dia_vencimiento: 28, color: '#57A773', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-per') },
  { id: 'srv-seg', user_id: 'demo', planilla_id: 'pl-auto', nombre: 'Seguro auto', empresa: 'La Caja', nro_cliente: 'Póliza 88-4521', url_pago: 'https://www.lacaja.com.ar', email_remitente: null, dia_vencimiento: 15, color: '#5BA8C4', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-auto') },
  { id: 'srv-pat', user_id: 'demo', planilla_id: 'pl-auto', nombre: 'Patente', empresa: 'Rentas Tucumán', nro_cliente: 'Dominio AB123CD', url_pago: null, email_remitente: null, dia_vencimiento: 25, color: '#C47BA8', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-auto') },
  { id: 'srv-coch', user_id: 'demo', planilla_id: 'pl-auto', nombre: 'Cochera', empresa: 'Garage Centro', nro_cliente: null, url_pago: null, email_remitente: null, dia_vencimiento: 5, color: '#7B8DC4', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-auto') },
  { id: 'srv-naf', user_id: 'demo', planilla_id: 'pl-auto', nombre: 'Nafta', empresa: 'YPF', nro_cliente: null, url_pago: null, email_remitente: null, dia_vencimiento: null, color: '#D98A4B', activo: true, acumulable: true, created_at: ahora, planillas: planillaResumen('pl-auto') },
  // Planilla Trabajo (ingreso)
  { id: 'srv-sueldo', user_id: 'demo', planilla_id: 'pl-trabajo', nombre: 'Sueldo', empresa: null, nro_cliente: null, url_pago: null, email_remitente: null, dia_vencimiento: null, color: '#4A90A4', activo: true, acumulable: false, created_at: ahora, planillas: planillaResumen('pl-trabajo') },
  { id: 'srv-freelance', user_id: 'demo', planilla_id: 'pl-trabajo', nombre: 'Freelance', empresa: null, nro_cliente: null, url_pago: null, email_remitente: null, dia_vencimiento: null, color: '#8A6FA5', activo: true, acumulable: true, created_at: ahora, planillas: planillaResumen('pl-trabajo') },
];
